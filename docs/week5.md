...
- Learned monitoring basics with CloudWatch & CloudTrail
- Configured alarms and logs (basic setup)
- Understood AWS cost overview
- Completed Udemy Course Sessions 11-12
Bonus: RDS Read Replicas
...
- Screenshot: RDS_replica_psql_screenshot.png
